...
var breeze = 0.2;  // breeziness level (applied as brief left & right gusts) //todo mit lüfter verbinden
...
var sunRays = [], sunRayCount = 0;//todo remove
var shadows = [], shadowCount = 0;//todo remove
